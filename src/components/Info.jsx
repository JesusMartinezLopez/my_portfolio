...
const Info = () => {
  ...
  return (
    <div className='flex flex-col w-full items-center justify-center mt-8 cursor-default overflow-auto'>
      ...
      <div className='flex flex-col w-full items-center justify-center sm:mt-[2.5%] mt-12'>
        <p className='text-white text-[32px] font-poppins text-center'>{language.info.infoCreated}</p>
        <div className='flex flex-col sm:flex-row w-[40%] items-center justify-evenly sm:mt-[2.3%] mt-6'>
